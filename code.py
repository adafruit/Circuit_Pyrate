...
pyrate = adafruit_circuitpyrate.Pyrate(serial, serial, aux_pin=board.A1, adc_pin=board.A0, miso_pin=board.MISO, cs_pin=board.A1, clock_pin=board.SCL, mosi_pin=board.SDA, scl_pin=board.SCL1, sda_pin=board.SDA1)
